...
export name='GabrielGardinii'
export email="gabriel.gardini@etec.sp.gov.br"
export repositorio="https://github.com/GabrielGardinii/JavaScript-Alert-Confirm-prompt.git";
